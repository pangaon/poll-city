...
| Walk App + GPS | Canvassing & Field | ✅ Built & Verified | /canvassing/walk | /api/canvasser/location, /api/canvass, /api/households/[id] | CanvassAssignment, CanvasserLocation, Household | Strong | High | Added household visited tracking, offline queued visit sync, and audit-backed household status updates. |
...
| Volunteer Management | Volunteers | ✅ Built & Verified | /volunteers | /api/volunteers, /api/volunteers/stats, /api/volunteers/shifts/[id]/checkin, /api/volunteers/expenses/[id] | VolunteerProfile, VolunteerShift, VolunteerExpense | Yes | High | Added shift-hour crediting, manager expense status transitions, and volunteer ops metric cards. |
