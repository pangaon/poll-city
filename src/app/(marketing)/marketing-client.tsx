...
const PRODUCTS = [
  {
    ...
    features: [
      ...
      "Volunteer management with scheduling, tracked hours, and live program metrics",
      ...
      "Volunteer expenses with manager approval/rejection/reimbursement workflow",
      ...
      "Unified contact timeline combining interactions, tasks, and activity logs with filtering and search",
