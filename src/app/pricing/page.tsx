...
const PLANS: Plan[] = [
  {
    id: "campaign",
    label: "Campaign",
    tagline: "Full campaign operations — launch to election night",
    popular: true,
    features: [
      "Campaign website with custom domain",
      "Full CRM + contact management",
      "Canvassing + walk lists + GPS",
      "Email & SMS campaigns",
      "AI content generator (Adoni)",
      "GOTV engine + priority lists",
      "Analytics & reporting",
      "Budget & donation tracking",
      "Resource studio + templates",
      "Print marketplace",
      "Calendar & events",
  ...
  },
  {
    id: "command",
    label: "Command",
    tagline: "Enterprise — war room, automations, API, white-label",
    features: [
