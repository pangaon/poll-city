        ...
        {campaignId && (
          <div className="relative" ref={alertRef}>
            <button
              ...
              className="relative inline-flex items-center justify-center w-9 h-9 rounded-lg text-gray-600 hover:bg-gray-50 transition-colors"
              ...
              <>
                ...
                <div className="absolute right-0 top-full mt-1.5 w-72 bg-white border border-gray-200 rounded-xl shadow-lg z-20 overflow-hidden">
                  <div className="flex items-center justify-between px-3 py-2.5 border-b border-gray-100 bg-gray-50">
                    <p className="text-xs font-bold text-gray-700 uppercase tracking-wider">Campaign Alerts</p>
                    <Link href="/alerts" onClick={() => setAlertOpen(false)} className="text-xs text-blue-600 hover:underline font-medium flex items-center gap-0.5">
                      ...
                      {alertData.top.map((a) => (
                        <Link key={a.id} href="/alerts" onClick={() => setAlertOpen(false)}
                          ...
                          <div className="min-w-0 flex-1">
                            <p className="text-xs font-semibold text-gray-800 leading-snug truncate">{a.title}</p>
