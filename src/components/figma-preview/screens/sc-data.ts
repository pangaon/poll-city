/* ─────────────────────────────────────────────────────────────────────
   ...
   Ported from figma_design_pollcity_iosapp/pages/Social/sc-data.ts
   ───────────────────────────────────────────────────────────────────── */
...
export const MISSIONS = [
  { id: "m1", type: "canvass" as const,   name: "GOTV — Bloor St. E Sweep",         reward: "800 XP", doors: 12, priority: "Critical", routing: "Odd Side Only",  start: 0,   end: 12  },
  { id: "m2", type: "lit-drop" as const,  name: "Parkdale–High Park Lit Drop",       reward: "300 XP", doors: 45, priority: "Standard", routing: "Even Side Only", start: 12,  end: 57  },
  { id: "m3", type: "canvass" as const,   name: "King St. West — Undecided Targets", reward: "600 XP", doors: 24, priority: "Elevated", routing: "All Addresses",  start: 57,  end: 81  },
  { id: "m4", type: "canvass" as const,   name: "Dufferin St. — Sign Sweep",        reward: "400 XP", doors: 18, priority: "Standard", routing: "Full Block",     start: 81,  end: 99  },
  { id: "m5", type: "lit-drop" as const,  name: "Danforth Ave. South Drop",          reward: "250 XP", doors: 30, priority: "Standard", routing: "Even Side Only", start: 99,  end: 129 },
];
