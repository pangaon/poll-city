      ...
      <header className="mb-8 flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-black text-[#F5F7FF] tracking-tighter uppercase drop-shadow-[0_0_15px_rgba(255,255,255,0.5)] flex items-center gap-3">
            <CheckSquare className="text-[#00E5FF]" size={28} /> Action Items
          </h1>
          <p className="text-[#AAB2FF] mt-2 font-medium tracking-wide">High-velocity task assignment and completion tracking.</p>
        </div>
        <button className="bg-[#FF3B30] text-[#F5F7FF] px-6 py-2.5 rounded font-black uppercase tracking-[0.2em] hover:bg-[#FFD600] hover:text-[#050A1F] transition-all shadow-[0_0_20px_rgba(255,59,48,0.4)]">
          Deploy Task
        </button>
      </header>
            ...
            <div className="flex-1 bg-[#0F1440]/60 backdrop-blur-xl rounded-xl border border-[#2979FF]/20 p-4 space-y-4">
              {[1, 2, 3].map(i => (
                <div key={i} className="bg-[#050A1F] p-4 rounded border border-[#2979FF]/40 hover:border-[#00E5FF]/60 transition-all cursor-pointer group shadow-[0_5px_15px_rgba(0,0,0,0.5)]">
                  ...
                  <h4 className="text-sm font-black text-[#F5F7FF] mb-2 group-hover:text-[#00E5FF] transition-colors">Call Key Donors</h4>
                  <div className="w-full bg-[#0F1440] h-1.5 rounded-full overflow-hidden">
                    <div className="bg-[#00E5FF] w-1/2 h-full shadow-[0_0_10px_#00E5FF]"></div>
                  </div>
                </div>
              ))}
            </div>
