...
import { Zap, Crosshair, Target, Activity, LayoutDashboard, Smartphone, ArrowRight } from "lucide-react";
import { motion } from "motion/react";
import pollCityLogo from "../../../imports/Poll_City_Logo.png";

export function MarketingLayout() {
  return (
    <div className="min-h-screen bg-[#050A1F] text-[#F5F7FF] font-sans selection:bg-[#00E5FF]/30 selection:text-[#00E5FF] flex flex-col relative overflow-hidden">
      ...
      <nav className="border-b border-[#2979FF]/20 sticky top-0 bg-[#0F1440]/80 backdrop-blur-xl z-50 shadow-[0_10px_30px_rgba(0,0,0,0.5)]">
        <div className="max-w-[1400px] mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex items-center gap-10">
            <Link to="/" className="text-2xl font-black tracking-tighter text-[#F5F7FF] flex items-center gap-3 drop-shadow-[0_0_10px_rgba(41,121,255,0.8)] uppercase">
              <img src={pollCityLogo} alt="Poll City Logo" className="w-10 h-10 object-contain drop-shadow-[0_0_20px_rgba(0,229,255,0.8)] hover:-translate-y-1 transition-transform" />
              Poll City Ecosystem
            </Link>
          </div>
      ...
      <div className="max-w-[1400px] mx-auto px-6">
        ...
        >
          <div className="inline-flex items-center gap-3 px-4 py-1.5 rounded-full bg-[#00E5FF]/10 text-[#00E5FF] text-[10px] font-black uppercase tracking-[0.2em] mb-6 border border-[#00E5FF]/30 shadow-[0_0_15px_rgba(0,229,255,0.2)] animate-pulse">
            <span className="flex h-2 w-2 rounded-full bg-[#00E5FF] shadow-[0_0_8px_#00E5FF]"></span>
          ...
          <h1 className="text-5xl md:text-[72px] font-black tracking-tighter text-[#F5F7FF] leading-[0.9] mb-6 drop-shadow-[0_10px_30px_rgba(0,0,0,0.8)] uppercase">
            Choose Your <br /> <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#00E5FF] to-[#2979FF] drop-shadow-[0_0_20px_rgba(0,229,255,0.4)]">Application.</span>
          </h1>
        ...
        <div className="grid md:grid-cols-2 gap-10 max-w-6xl mx-auto">
          ...
          >
            <div className="absolute inset-0 bg-gradient-to-br from-[#2979FF]/20 to-[#00E5FF]/5 rounded-2xl blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none"></div>
            <Link 
              to="/social/command" 
            ...
            >
              ...
              <h2 className="text-3xl font-black uppercase tracking-tight text-[#F5F7FF] mb-4 group-hover:text-[#00E5FF] transition-colors">Poll City<br/>Command Center</h2>
          ...
          <motion.div
            ...
            className="group relative"
          >
            <div className="absolute inset-0 bg-gradient-to-br from-[#FF3B30]/20 to-[#FFD600]/5 rounded-2xl blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none"></div>
            <Link 
              to="/social" 
            ...
            >
              ...
              <h2 className="text-3xl font-black uppercase tracking-tight text-[#FFFFFF] mb-4 group-hover:text-[#FF3B30] transition-colors">Poll City<br/>Social App</h2>
              <p className="text-[#B0B3C0] leading-relaxed mb-10 flex-1">
                The public-facing mobile polling application. Swipe-based UI with gamified voting, live trending sentiment, and a decentralized feed.
              </p>
