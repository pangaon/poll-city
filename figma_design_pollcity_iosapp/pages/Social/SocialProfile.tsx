...
import { Settings, Share2, TrendingUp, ThumbsUp, ThumbsDown, BarChart2, Award, Zap, ChevronRight } from "lucide-react";
...
const USER_POLLS = [
  {
    id: 1,
    question: "Should we reallocate 15% of the transportation budget to expand the Riverfront Park?",
    agrees: 1420,
    opposes: 890,
    views: "2.3K",
    trending: true,
  ...
  {
    id: 2,
    question: "Do you support the new proposed tax incentives for clean energy startups?",
    agrees: 3200,
    opposes: 4100,
    views: "7.3K",
    trending: false,
  ...
  {
    id: 3,
    question: "Is the current school board doing enough to integrate AI literacy into the curriculum?",
    agrees: 850,
    opposes: 2100,
    views: "2.9K",
    trending: false,
    ...
    <div className="h-full w-full bg-[#0B0B0F] overflow-y-auto pt-14 pb-6">
      ...
      <div className="relative mb-6 overflow-hidden">
        ...
        <div className="h-32 bg-gradient-to-br from-[#00E5FF]/20 via-[#2979FF]/20 to-[#800080]/20 relative">
          <div className="absolute inset-0 bg-[#0B0B0F]/60 backdrop-blur-sm"></div>
        </div>
        ...
        <div className="px-6 -mt-16 relative z-10">
          ...
          {/* User Info */}
          <div className="mb-4">
            <h1 className="text-2xl font-black text-[#FFFFFF] tracking-tight uppercase drop-shadow-[0_0_10px_rgba(255,255,255,0.5)] mb-1">
              Jane Voter
            </h1>
          ...
          <p className="text-[14px] text-[#AAB2FF] mb-4 leading-relaxed max-w-md">
            Making my voice heard on the issues that matter. Democracy is a contact sport. 🗳️
          </p>
          ...
          <div className="flex gap-3 mb-6">
            ...
            <button className="flex-1 py-3 bg-[#141419] border border-[#FFFFFF]/20 text-[#FFFFFF] rounded-xl text-[11px] font-black uppercase tracking-widest hover:border-[#00E5FF]/50 hover:bg-[#141419]/80 transition-all flex items-center justify-center gap-2 shadow-[0_0_20px_rgba(0,0,0,0.5)]">
          ...
          <div className="grid grid-cols-2 gap-3 mb-6">
            {USER_STATS.map((stat, idx) => {
              ...
              return (
                <div
                  key={idx}
                  className="bg-[#141419]/80 backdrop-blur-xl rounded-xl border border-[#FFFFFF]/10 p-4 shadow-[0_0_20px_rgba(0,0,0,0.5)] relative overflow-hidden group"
                >
                  <div
                    className="absolute top-0 right-0 w-20 h-20 rounded-full blur-[40px] opacity-20 group-hover:opacity-30 transition-opacity"
                    style={{ backgroundColor: stat.color }}
                  />
                  <div className="relative z-10">
                    <div className="flex items-center gap-2 mb-2">
                      <Icon size={14} style={{ color: stat.color }} />
                      <span className="text-[10px] font-black uppercase tracking-widest text-[#6C6F7F]">
                        {stat.label}
                      </span>
                    </div>
      ...
      <div className="px-6 mb-6">
        <div className="flex bg-[#141419] p-1.5 rounded-xl border border-[#FFFFFF]/10 shadow-[0_0_20px_rgba(0,0,0,0.5)]">
          {["polls", "activity", "achievements"].map((tab) => (
            <button
              key={tab}
              ...
              className={cn(
                ...
                activeTab === tab
                  ? "bg-[#FFFFFF] text-[#0B0B0F] shadow-[0_0_15px_rgba(255,255,255,0.8)]"
                  : "text-[#B0B3C0] hover:text-[#FFFFFF]"
              )}
            >
              {tab}
            </button>
              ...
              return (
                ...
                >
                  <div className="flex items-start justify-between gap-3 mb-3">
                    <h3 className="text-[14px] font-bold text-[#FFFFFF] leading-tight flex-1 group-hover:text-[#00E5FF] transition-colors">
                      {poll.question}
                    </h3>
                    {poll.trending && (
                      <div className="flex items-center gap-1 text-[10px] font-black uppercase tracking-widest bg-[#FF3B30]/20 text-[#FF3B30] px-2 py-1 rounded border border-[#FF3B30]/50 flex-shrink-0 shadow-[0_0_10px_rgba(255,59,48,0.3)] animate-pulse">
                  ...
                  <div className="mb-3">
                    <div className="flex gap-2 mb-2">
                      <div className="flex-1 h-2 bg-[#0B0B0F] rounded-full overflow-hidden border border-[#FFFFFF]/10">
                        <div
                          className="h-full bg-gradient-to-r from-[#00E676] to-[#00C853] shadow-[0_0_10px_#00E676]"
                          style={{ width: `${agreePercent}%` }}
                        />
                      </div>
                      <div className="flex-1 h-2 bg-[#0B0B0F] rounded-full overflow-hidden border border-[#FFFFFF]/10">
                        <div
                          className="h-full bg-gradient-to-l from-[#FF3B30] to-[#D50000] shadow-[0_0_10px_#FF3B30]"
          ...
          <div className="grid grid-cols-3 gap-3">
            {ACHIEVEMENTS.map((achievement, idx) => (
              ...
              >
                ...
                <span className="text-[9px] font-black uppercase tracking-widest text-[#FFFFFF] text-center leading-tight">
                  {achievement.name}
                </span>
                {achievement.unlocked && (
