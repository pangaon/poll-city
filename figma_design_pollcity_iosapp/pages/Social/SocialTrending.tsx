...
const TRENDING_TOPICS = [
  { 
    id: 1, 
    topic: "Climate Action Budget", 
    views: "124K", 
    polls: 23, 
    growth: "+890%", 
    velocity: "🔥", 
    sentiment: 68,
    tags: ["Environment", "Local", "Budget"],
    trending: 1
  },
  { 
    id: 2, 
    topic: "Tech Tax Breaks", 
    views: "98K", 
    polls: 18, 
    growth: "+620%", 
    velocity: "🔥", 
    sentiment: 42,
    tags: ["Economy", "Tech", "State"],
    trending: 2
  },
  { 
    id: 3, 
  ...
  { 
    id: 4, 
    topic: "School Board AI Literacy", 
    views: "76K", 
    polls: 14, 
    growth: "+380%", 
    velocity: "⚡", 
  ...
  { 
    id: 5, 
    topic: "Downtown Housing Density", 
    views: "62K", 
    polls: 27, 
    growth: "+310%", 
    velocity: "↗", 
  ...
  { 
    id: 6, 
    topic: "Police Body Camera Mandate", 
    views: "58K", 
    polls: 19, 
    growth: "+280%", 
    velocity: "↗", 
                ...
                <div className="flex-1">
                  ...
                  <div className="flex flex-wrap gap-1.5 mb-3">
                    {topic.tags.map((tag, i) => (
                      <span 
                        key={i} 
                        className="text-[9px] font-black uppercase tracking-wider bg-[#FFFFFF]/10 text-[#B0B3C0] px-2 py-0.5 rounded border border-[#FFFFFF]/10"
                      >
                        {tag}
                      </span>
                    ))}
                  ...
                  <div className="flex items-center gap-4 text-[11px] font-bold">
                    ...
                    <div className="flex items-center gap-1.5 text-[#AAB2FF]">
                      <MessageCircle size={12} />
                      <span>{topic.polls} polls</span>
                    </div>
                  ...
                  <div className="relative w-16 h-16">
                    <svg className="w-16 h-16 -rotate-90">
                      ...
                      <circle
                        ...
                        strokeDashoffset={`${2 * Math.PI * 28 * (1 - topic.sentiment / 100)}`}
                        strokeLinecap="round"
                        style={{ 
                          filter: `drop-shadow(0 0 8px ${sentimentColor})`,
