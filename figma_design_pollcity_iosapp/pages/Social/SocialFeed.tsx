...
const POLLS = [
  { id: 1, author: "Mayor Chen", handle: "@mayorchen", question: "Should we reallocate 15% of the transportation budget to expand the Riverfront Park?", img: "figma:asset/park.png", bg: "bg-gradient-to-br from-[#00E5FF] to-[#2979FF]", tags: ["Local", "Environment"], yes: 1420, no: 890, trend: "+12.4%" },
  { id: 2, author: "Tech Forward IL", handle: "@techil", question: "Do you support the new proposed tax incentives for clean energy startups?", img: "figma:asset/solar.png", bg: "bg-gradient-to-br from-[#FFD600] to-[#FF3B30]", tags: ["Economy", "Taxes"], yes: 3200, no: 4100, trend: "-4.2%" },
  { id: 3, author: "Poll City Daily", handle: "@pollcitynews", question: "Is the current school board doing enough to integrate AI literacy into the curriculum?", img: "figma:asset/school.png", bg: "bg-gradient-to-br from-[#FF3B30] to-[#800080]", tags: ["Education", "Trending"], yes: 850, no: 2100, trend: "+89.1%" },
];

function Card({ poll, setExitX, index, setIndex }: any) {
  ...
  return (
    ...
    >
      <div className={cn("w-full h-full relative flex flex-col p-6 text-[#FFFFFF] justify-between transition-all duration-300", poll.bg)}>
        ...
        <div className="relative z-10 mt-auto mb-16">
          ...
          <h2 className="text-4xl font-black leading-[1.1] tracking-tighter text-balance drop-shadow-[0_5px_20px_rgba(0,0,0,1)]">
            {poll.question}
          </h2>
          ...
          <div className="text-[12px] font-mono text-[#B0B3C0] mt-6 flex items-center gap-4 uppercase tracking-widest">
            ...
            <span className="w-1.5 h-1.5 rounded-full bg-[#FFFFFF]/30"></span>
            <span className={cn(
              "flex items-center gap-1 px-2 py-0.5 rounded font-black",
              isUp ? "text-[#00E676] bg-[#00E676]/10" : "text-[#FF3B30] bg-[#FF3B30]/10"
            )}>
        ...
        {/* Voting Hint (shows on drag) */}
        <motion.div 
          style={{ opacity: useTransform(x, [20, 80], [0, 1]), scale: useTransform(x, [20, 80], [0.8, 1]) }}
        ...
        >
          <div className="text-[80px] font-black italic text-[#00E676] drop-shadow-[0_0_30px_#00E676] tracking-tighter uppercase transform rotate-[-10deg]">AGREE</div>
        </motion.div>
        ...
        >
          <div className="text-[80px] font-black italic text-[#FF3B30] drop-shadow-[0_0_30px_#FF3B30] tracking-tighter uppercase transform rotate-[10deg]">OPPOSE</div>
        </motion.div>
      </div>
    </motion.div>
  );
    ...
    <div className="h-full w-full relative flex flex-col pt-14 bg-[#0B0B0F]">
      ...
      <header className="px-6 flex justify-between items-center mb-4 z-20 relative">
        <h1 className="text-2xl font-black text-[#FFFFFF] tracking-tighter uppercase drop-shadow-[0_0_10px_rgba(255,255,255,0.5)] flex items-center gap-2">
          <img src={pollCityLogo} alt="Poll City Logo" className="w-8 h-8 object-contain drop-shadow-[0_0_15px_rgba(0,229,255,0.8)] hover:-translate-y-1 transition-transform" />
          Poll City
        </h1>
      ...
      {/* Cards Area */}
      <div className="flex-1 relative w-full h-full perspective-[1500px]">
          ...
          {POLLS.slice(index, index + 2).reverse().map((poll, i) => {
            ...
            if (!isFront) {
              return (
                ...
                >
                  <div className={cn("w-full h-full opacity-40 blur-md saturate-200 grayscale-50", poll.bg)} />
                </motion.div>
              );
            }
      ...
      <div className="absolute right-6 bottom-[25%] flex flex-col gap-6 z-40">
        <button className="flex flex-col items-center gap-2 hover:scale-110 transition-transform group">
          <div className="w-14 h-14 bg-[#141419]/90 backdrop-blur-xl rounded-full shadow-[0_0_20px_rgba(0,0,0,0.8)] flex items-center justify-center border border-[#FFFFFF]/10 group-hover:border-[#FF3B30]/50 transition-colors">
            <Heart size={26} className="text-[#FFFFFF] group-hover:fill-[#FF3B30] group-hover:text-[#FF3B30] drop-shadow-[0_0_10px_rgba(255,59,48,0)] group-hover:drop-shadow-[0_0_15px_#FF3B30] transition-all" />
          </div>
        ...
        <button className="flex flex-col items-center gap-2 hover:scale-110 transition-transform group">
          <div className="w-14 h-14 bg-[#141419]/90 backdrop-blur-xl rounded-full shadow-[0_0_20px_rgba(0,0,0,0.8)] flex items-center justify-center border border-[#FFFFFF]/10 group-hover:border-[#00E5FF]/50 transition-colors">
            <MessageCircle size={26} className="text-[#FFFFFF] group-hover:fill-[#00E5FF]/20 group-hover:text-[#00E5FF] drop-shadow-[0_0_10px_rgba(0,229,255,0)] group-hover:drop-shadow-[0_0_15px_#00E5FF] transition-all" />
          </div>
        ...
        <button className="flex flex-col items-center gap-2 hover:scale-110 transition-transform group">
          <div className="w-14 h-14 bg-[#141419]/90 backdrop-blur-xl rounded-full shadow-[0_0_20px_rgba(0,0,0,0.8)] flex items-center justify-center border border-[#FFFFFF]/10 group-hover:border-[#00E676]/50 transition-colors">
            <Share2 size={26} className="text-[#FFFFFF] group-hover:text-[#00E676] drop-shadow-[0_0_10px_rgba(0,230,118,0)] group-hover:drop-shadow-[0_0_15px_#00E676] transition-all" />
          </div>
