...
| Chunk 7 — Turf + Geography + Route Planning (APIs + UI full) | CLAIMED 2026-04-10 | Full turf assignment, boundary visualization |
...
| Phase 3 — Scheduled messages + cron | PENDING | ScheduledMessage model + send cron |
