...
| Electron Desktop App — Mac (.dmg) + Windows (.exe) installer, system tray, auto-updates, deep links | CLAIMED 2026-04-18 | desktop/ folder: Electron shell → app.poll.city, electron-builder, electron-updater. George needs icon files + code signing certs. |
